...
const MenProductSlider = () => {
    ...
    const printedCapProducts = allproducts.filter(product => 
        product.sub_category_title === "Printed Cap" || product.sub_category_title === "Plain Cap" || product.product_for === 'unisex'
    );
        ...
        <section className="product__section color-scheme-2 pt-5 bg-gray">
            <div className="container">
                <div className="section__heading text-center mb-35">
                    <h2 className="section__heading--maintitle style2">Caps</h2>
                </div>
                <div className="product__section--inner">
                    {isProductLoading ? (
                        ...
                        printedCapProducts.length > 0 && (
                            <Slider {...Capsettings}>
                                {printedCapProducts.map((item, index) => (
                                    <div className="col mb-30" key={index}>
                                        <div className="product__items new-product">
                                            <div className="product__items--thumbnail">
                                                ...
                                                <Link
                                                    ...
                                                    <span className="product__items--content__subtitle">{item.sub_category_title}</span> <br />
